                    ...
                    <div class="login-form">
                        <form method="post" action="{{ route('login') }}" class="form-default-wrapper">
                            ...
                            <div class="block-form-group">
                                <div class="block-field block-field-entity-partner-name @error('email') is-invalid @enderror">
                                    ...
                                    <div class="block-input ">
                                        <input id="email" type="email" class="form-control" name="email" value="{{ old('email') }}" required autocomplete="email" placeholder="{{ __('E-mail') }}" autofocus>
                                    </div>
                                </div>
                                @error('email')
                            ...
                            <div class="password-recover">
                                <p>{{ __('Esqueceu-se da password?') }} <span><a href="{{ route('password.request') }}">{{ __('Recuperar') }}</a></span></p>
                            </div>
