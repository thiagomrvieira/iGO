            ...
            <div class="block-login">
                <div class="login">
                    ...
                    <div class="login-form">
                        <form method="post" class="form-default-wrapper">
                            <div class="block-form-group">
                                <div class="block-field block-field-entity-partner-name">
                                    ...
                                    <div class="block-input">
                                        <input type="text" id="email" name="email" placeholder="E-mail" @change="removeClassError('partnerCreation', 'name')" v-model="partner.name">
                                    </div>
                                </div> 
                            ...
                            <div class="block-form-group">
                                <div class="block-field block-field-entity-partner-name">
                                    ...
                                    <div class="block-input">
                                        <input type="text" id="password" name="password" placeholder="Password" @change="removeClassError('partnerCreation', 'name')" v-model="partner.name">
                                    </div>
                                </div> 
                                <div class="block-field-msg" v-if="partnerErrors.includes('name')">
                                    <small id="nameHelp" class="text-danger" >{{ __('Campo obrigatório') }}</small>
