  ...
  {{-- @isset($about)
    ...
    {{-- <div class="block-about-us">
        <div class="img-full">
            ...
            <img src="/assets-frontoffice/images/about-us.png" alt="About us">
        </div>
