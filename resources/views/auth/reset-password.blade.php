            ...
            <div class="block-login">
                <div class="limit-wrapper">
                    ...
                    <div class="login-form">
                        <form method="post" action="{{ route('password.update') }}" class="form-default-wrapper">
                            @csrf
                            <input type="hidden" name="token" value="{{ $request->route('token') }}">
                            <div class="block-form-group">
                                <div
                                    class="block-field block-field-entity-partner-name @error('email') is-invalid @enderror">
                                    ...
                                    <div class="block-input ">
                                        <input id="email" type="email" class="form-control" name="email" value="{{ old('email', $request->email) }}" placeholder="{{ __('E-mail') }}" required autofocus>
                                    </div>
                                </div>
                                @error('email')
                            ...
                            <button type="submit" class="button button-primary">{{ __('Entrar') }}</button>
                        </form>
                    </div>
                </div>
            </div>
