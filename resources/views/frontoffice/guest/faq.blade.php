			...
			<div class="main-fluid">
				<div class="limit-wrapper">
					<div class="block-faqs">
						<div class="block-faqs-title">
							<h2>{{ __('FAQs') }}</h2>
						</div>
						<div class="block-faqs-list">
							@foreach ($content as $faq)
								<div class="block-faqs-item">
									<div class="block-faqs-header">
										<div class="block-faqs-header-title"><span>{{ $faq->title }}</span></div>
										<div class="block-faqs-header-icon">
											<svg xmlns="http://www.w3.org/2000/svg" width="44" height="44" viewBox="0 0 44 44">
												<g transform="translate(282 -315) rotate(90)">
													<g transform="translate(0 14.883)">
														<path d="M-3.816-.278,2.652-4.553l-6.469-4.3,1.411-2.215,9.569,6.5-9.569,6.5Z" transform="translate(335.385 249.847)" fill="#687780"></path>
														<rect width="14" height="14" transform="translate(330 238.117)" fill="none"></rect>
													</g>
													<rect width="44" height="44" transform="translate(315 238)" fill="none"></rect>
												</g>
											</svg>
										</div>
									</div>
									<div class="block-faqs-body">
										{!! $faq->content ?? null !!}
									</div>
								</div>
							@endforeach
